...
<body>
  <table>
    ...
    $queryParams = '?' . urlencode('path') . '=' . urlencode('/shared/Universidad Continental 51UCCI_INST/Reports/TSI/1. Reportería mensualizada/Reporte de préstamos | uso interno') . '&' . urlencode('limit') . '=' . urlencode('1000') . '&' . urlencode('apikey') . '=' . urlencode('l8xx3de7899a5e1e42fa94a78cc91f8305b1');
