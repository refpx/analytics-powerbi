...
<body>
  <table>
    ...
    $queryParams = '?' . urlencode('path') . '=' . urlencode('Location	/shared/Universidad Continental 51UCCI_INST/Reports/TSI/1. Reportería mensualizada') . '&' . urlencode('limit') . '=' . urlencode('1000') . '&' . urlencode('apikey') . '=' . urlencode('l8xx3de7899a5e1e42fa94a78cc91f8305b1');
